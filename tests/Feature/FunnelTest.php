...
class FunnelTest extends TestCase
{
    ...
    public function test_user_can_create_a_funnel()
    {
    ...
    public function test_index_only_returns_the_authenticated_users_funnels()
    {
        $user = User::factory()->create();
    ...
    public function test_user_cannot_access_another_users_funnel()
    {
        $user = User::factory()->create();
        $other = User::factory()->create();
